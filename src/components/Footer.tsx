          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <Link href="/" className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-portland-red rounded-xl flex items-center justify-center">
              ...
              <ul className="space-y-3">
                {NAV_LINKS.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-white/60 hover:text-portland-red-light text-sm transition-colors duration-300"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <MapPin className="w-4 h-4 text-portland-red mt-0.5 shrink-0" />
                  <div>
                ...
                <li className="flex items-center gap-3">
                  <Phone className="w-4 h-4 text-portland-red shrink-0" />
                  <a
                    href={`tel:${SITE.phone}`}
                ...
                <li className="flex items-center gap-3">
                  <Mail className="w-4 h-4 text-portland-red shrink-0" />
                  <a
            ...
            <div>
              ...
              <p className="text-white/60 text-sm mb-5 leading-relaxed">
                Give your child the Portland advantage. Admissions are open for
                Grade RR – Grade 11.
              </p>
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-white/40 text-sm">
                &copy; {new Date().getFullYear()} Portland Group of Schools. All
                rights reserved.
              </p>
              <p className="text-white/40 text-sm flex items-center gap-1.5">
                Made with <Heart className="w-3.5 h-3.5 text-portland-red fill-portland-red" /> in Johannesburg
              </p>
            </div>
          </div>
        </div>
